...
parser.add_argument('--input1', required=True, help='Path to data excel file of data to predict')
parser.add_argument('--input2', required=True, help='Allowed classification error')
parser.add_argument('--input3', required=False, help='Path to data excel file of data to train')
parser.add_argument('--input4', required=False, help='Number of categories')

args = parser.parse_args()

path_predict = args.input1
allowed_error = args.input2
path = args.input3
categs = args.input4
...
original_data = original_data[['tweet_text', 'CES']]
n_categ = 3
